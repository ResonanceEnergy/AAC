...
.DESCRIPTION
    ⚠️  DEPRECATED: This script is deprecated and will be removed.
       Use 'python aac_master_launcher.py' instead.
...
.EXAMPLE
    .\Start-ACC.ps1 -Mode paper  # DEPRECATED
    python aac_master_launcher.py --mode paper  # NEW WAY
#>
