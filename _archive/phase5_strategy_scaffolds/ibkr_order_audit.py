...
async def main() -> None:
    parser = argparse.ArgumentParser(description="IBKR Order Audit + Balance Maximization")
    parser.add_argument("--balance", type=float, default=0,
                        help="Account balance USD (0=auto from config/account_balances)")
    ...
    if args.balance <= 0:
        ...
        args.balance = Balances.ibkr_total()
