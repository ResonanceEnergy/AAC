...
⚠️  DEPRECATED: This file is deprecated and will be removed.
   Use 'python aac_master_launcher.py' instead for complete system startup.

Usage:
    python main.py                    # Run full system (DEPRECATED)
    python main.py --paper            # Paper trading mode (default) (DEPRECATED)
    python main.py --dry-run          # Dry run mode (no orders) (DEPRECATED)
    python main.py --check            # Health check only (DEPRECATED)
