...
var _TxClient_instances, _TxClient_plugin, _TxClient_transactionId, _TxClient_txnStartMetadata, _TxClient_metadata_get, _RedisClient_instances, _RedisClient_metadata_get, _RedisClient_plugin_get;
import { BitfieldOverflowBehavior, RedisKeyScope, } from '@devvit/protos/json/devvit/plugin/redis/redisapi.js';
...
export class RedisClient {
    ...
    async zRange(key, start, stop, options) {
        ...
        return (await __classPrivateFieldGet(this, _RedisClient_instances, "a", _RedisClient_plugin_get).ZRange({ key: { key: key }, start: start + '', stop: stop + '', ...opts, scope: this.scope }, __classPrivateFieldGet(this, _RedisClient_instances, "a", _RedisClient_metadata_get))).members;
    }
    async zRem(key, members) {
    ...
    async type(key) {
        const response = await __classPrivateFieldGet(this, _RedisClient_instances, "a", _RedisClient_plugin_get).Type({ key: key, scope: this.scope }, __classPrivateFieldGet(this, _RedisClient_instances, "a", _RedisClient_metadata_get));
        return response !== null ? response.value : response;
    }
...
_RedisClient_instances = new WeakSet(), _RedisClient_metadata_get = function _RedisClient_metadata_get() {
