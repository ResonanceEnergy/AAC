...
export interface CacheUtilsTwirp<T extends TwirpContext = TwirpContext> {
    ...
    PurgeAppVersionPublishStatus(ctx: T, request: AppVersionPublishStatusPurgeRequest): Promise<PurgeResult>;
    PurgeAll(ctx: T, request: PurgeAllRequest): Promise<PurgeResult>;
}
export declare enum CacheUtilsMethod {
    ...
    PurgeApp = "PurgeApp",
    PurgeAppVersionPublishStatus = "PurgeAppVersionPublishStatus",
    PurgeAll = "PurgeAll"
}
