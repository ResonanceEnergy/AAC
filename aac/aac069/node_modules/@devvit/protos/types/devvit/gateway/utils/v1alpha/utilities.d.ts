...
export interface AppVersionPublishStatusPurgeRequest {
    appVersionId: string;
}
export interface PurgeAllRequest {
    cacheType: PurgeAllRequest_CacheType;
}
/** Purge all cache entries of the specified type */
export declare enum PurgeAllRequest_CacheType {
    UNSPECIFIED = 0,
...
export declare function purgeAllRequest_CacheTypeFromJSON(object: any): PurgeAllRequest_CacheType;
export declare function purgeAllRequest_CacheTypeToJSON(object: PurgeAllRequest_CacheType): number;
...
export declare const AppVersionPublishStatusPurgeRequest: {
    $type: "devvit.gateway.utils.v1alpha.AppVersionPublishStatusPurgeRequest";
    encode(message: AppVersionPublishStatusPurgeRequest, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): AppVersionPublishStatusPurgeRequest;
    fromJSON(object: any): AppVersionPublishStatusPurgeRequest;
    toJSON(message: AppVersionPublishStatusPurgeRequest): unknown;
    create(base?: DeepPartial<AppVersionPublishStatusPurgeRequest>): AppVersionPublishStatusPurgeRequest;
    fromPartial(object: DeepPartial<AppVersionPublishStatusPurgeRequest>): AppVersionPublishStatusPurgeRequest;
};
export declare const PurgeAllRequest: {
    $type: "devvit.gateway.utils.v1alpha.PurgeAllRequest";
    encode(message: PurgeAllRequest, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): PurgeAllRequest;
    fromJSON(object: any): PurgeAllRequest;
    toJSON(message: PurgeAllRequest): unknown;
    create(base?: DeepPartial<PurgeAllRequest>): PurgeAllRequest;
    fromPartial(object: DeepPartial<PurgeAllRequest>): PurgeAllRequest;
};
...
export interface CacheUtils {
    ...
    PurgeAppVersionPublishStatus(request: AppVersionPublishStatusPurgeRequest, metadata?: Metadata): Promise<PurgeResult>;
    PurgeAll(request: PurgeAllRequest, metadata?: Metadata): Promise<PurgeResult>;
}
...
export declare const CacheUtilsDefinition: {
    ...
    readonly methods: {
        ...
        readonly purgeAppVersionPublishStatus: {
            readonly name: "PurgeAppVersionPublishStatus";
            readonly requestType: {
                $type: "devvit.gateway.utils.v1alpha.AppVersionPublishStatusPurgeRequest";
                encode(message: AppVersionPublishStatusPurgeRequest, writer?: _m0.Writer): _m0.Writer;
                decode(input: _m0.Reader | Uint8Array, length?: number): AppVersionPublishStatusPurgeRequest;
