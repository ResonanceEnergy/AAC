...
export class CacheUtilsClientJSON {
    constructor(rpc) {
        ...
        this.PurgeAppVersionPublishStatus.bind(this);
        this.PurgeAll.bind(this);
    }
    ...
    PurgeAppVersionPublishStatus(request) {
        const data = AppVersionPublishStatusPurgeRequest.toJSON(request);
        const promise = this.rpc.request('devvit.gateway.utils.v1alpha.CacheUtils', 'PurgeAppVersionPublishStatus', 'application/json', data);
        return promise.then((data) => PurgeResult.fromJSON(data));
    }
    PurgeAll(request) {
        const data = PurgeAllRequest.toJSON(request);
        const promise = this.rpc.request('devvit.gateway.utils.v1alpha.CacheUtils', 'PurgeAll', 'application/json', data);
        return promise.then((data) => PurgeResult.fromJSON(data));
    }
}
export class CacheUtilsClientProtobuf {
    ...
    PurgeAppVersionPublishStatus(request) {
        ...
        const promise = this.rpc.request('devvit.gateway.utils.v1alpha.CacheUtils', 'PurgeAppVersionPublishStatus', 'application/protobuf', data);
        return promise.then((data) => PurgeResult.decode(data));
    }
    PurgeAll(request) {
        const data = PurgeAllRequest.encode(request).finish();
        const promise = this.rpc.request('devvit.gateway.utils.v1alpha.CacheUtils', 'PurgeAll', 'application/protobuf', data);
        return promise.then((data) => PurgeResult.decode(data));
    }
}
