...
class IvRvAlignmentTradesStrategy(BaseArbitrageStrategy):
    """
    IV–RV Alignment Trades
            ...
            for symbol in self.universe:
                ...
                if abs(signal_value) > self.threshold:
                    ...
                    metadata = {
                        ...
                        "strategy_name": "IV–RV Alignment Trades",
                        "category": "CORRELATION"
                    }

                    signal = TradingSignal(
                        strategy_id="correlation_14",
