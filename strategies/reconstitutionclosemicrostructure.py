"""
ReconstitutionCloseMicrostructureStrategy
=========================================
...
class ReconstitutionCloseMicrostructureStrategy(BaseArbitrageStrategy):
    """
    Reconstitution Close Microstructure
            ...
            for symbol in self.universe:
                ...
                if abs(signal_value) > self.threshold:
                    ...
                    metadata = {
                        ...
                        "strategy_name": "Reconstitution Close Microstructure",
                        "category": "INDEX_ARBITRAGE"
                    }

                    signal = TradingSignal(
                        strategy_id="index_arbitrage_31",
