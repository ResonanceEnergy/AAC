"""
ConditionalDependenceTradesStrategy
===================================
...
class ConditionalDependenceTradesStrategy(BaseArbitrageStrategy):
    """
    Conditional Dependence Trades
            ...
            for symbol in self.universe:
                ...
                if abs(signal_value) > self.threshold:
                    ...
                    metadata = {
                        ...
                        "strategy_name": "Conditional Dependence Trades",
                        "category": "CORRELATION"
                    }

                    signal = TradingSignal(
                        strategy_id="correlation_41",
