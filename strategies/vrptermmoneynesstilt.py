...
class VrpTermMoneynessTiltStrategy(BaseArbitrageStrategy):
    """
    VRP Term/Moneyness Tilt
            ...
            for symbol in self.universe:
                ...
                if abs(signal_value) > self.threshold:
                    ...
                    metadata = {
                        ...
                        "strategy_name": "VRP Term/Moneyness Tilt",
                        "category": "VOLATILITY_ARBITRAGE"
                    }

                    signal = TradingSignal(
                        strategy_id="volatility_arbitrage_21",
