...
class IcRcGateForDispersionStrategy(BaseArbitrageStrategy):
    """
    IC–RC Gate for Dispersion
            ...
            for symbol in self.universe:
                ...
                if abs(signal_value) > self.threshold:
                    ...
                    metadata = {
                        ...
                        "strategy_name": "IC–RC Gate for Dispersion",
                        "category": "VOLATILITY_ARBITRAGE"
                    }

                    signal = TradingSignal(
                        strategy_id="volatility_arbitrage_42",
