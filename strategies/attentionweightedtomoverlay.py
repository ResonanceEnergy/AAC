"""
AttentionWeightedTomOverlayStrategy
===================================
...
class AttentionWeightedTomOverlayStrategy(BaseArbitrageStrategy):
    """
    Attention-Weighted TOM Overlay
            ...
            for symbol in self.universe:
                ...
                if abs(signal_value) > self.threshold:
                    ...
                    metadata = {
                        ...
                        "strategy_name": "Attention-Weighted TOM Overlay",
                        "category": "CORRELATION"
                    }

                    signal = TradingSignal(
                        strategy_id="correlation_25",
