"""
MuniFundOutflowLiquidityProvisionStrategy
=========================================
...
class MuniFundOutflowLiquidityProvisionStrategy(BaseArbitrageStrategy):
    """
    Muni Fund Outflow Liquidity Provision
    ...
    async def generate_signals(self) -> List[TradingSignal]:
        """Generate flow_based arbitrage signals"""
        signals = []
            ...
            for symbol in self.universe:
                ...
                if abs(signal_value) > self.threshold:
                    ...
                    metadata = {
                        ...
                        "strategy_name": "Muni Fund Outflow Liquidity Provision",
                        "category": "FLOW_BASED"
                    }

                    signal = TradingSignal(
                        strategy_id="flow_based_35",
