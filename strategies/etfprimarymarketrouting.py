"""
EtfPrimaryMarketRoutingStrategy
===============================
...
class EtfPrimaryMarketRoutingStrategy(BaseArbitrageStrategy):
    """
    ETF Primary-Market Routing
            ...
            for symbol in self.universe:
                ...
                if abs(signal_value) > self.threshold:
                    ...
                    metadata = {
                        ...
                        "strategy_name": "ETF Primary-Market Routing",
                        "category": "ETF_ARBITRAGE"
                    }

                    signal = TradingSignal(
                        strategy_id="etf_arbitrage_19",
