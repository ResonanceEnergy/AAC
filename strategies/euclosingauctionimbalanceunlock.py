"""
EuClosingAuctionImbalanceUnlockStrategy
=======================================
...
class EuClosingAuctionImbalanceUnlockStrategy(BaseArbitrageStrategy):
    """
    EU Closing-Auction Imbalance Unlock
    ...
    async def generate_signals(self) -> List[TradingSignal]:
        """Generate market_making arbitrage signals"""
        signals = []
            ...
            for symbol in self.universe:
                ...
                if abs(signal_value) > self.threshold:
                    ...
                    metadata = {
                        ...
                        "strategy_name": "EU Closing-Auction Imbalance Unlock",
                        "category": "MARKET_MAKING"
                    }

                    signal = TradingSignal(
                        strategy_id="market_making_18",
