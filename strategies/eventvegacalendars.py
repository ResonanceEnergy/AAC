...
class EventVegaCalendarsStrategy(BaseArbitrageStrategy):
    """
    Event Vega Calendars
            ...
            for symbol in self.universe:
                ...
                if abs(signal_value) > self.threshold:
                    ...
                    metadata = {
                        ...
                        "strategy_name": "Event Vega Calendars",
                        "category": "EVENT_DRIVEN"
                    }

                    signal = TradingSignal(
                        strategy_id="event_driven_47",
