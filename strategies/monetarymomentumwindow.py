"""
MonetaryMomentumWindowStrategy
==============================
...
class MonetaryMomentumWindowStrategy(BaseArbitrageStrategy):
    """
    Monetary Momentum Window
            ...
            for symbol in self.universe:
                ...
                if abs(signal_value) > self.threshold:
                    ...
                    metadata = {
                        ...
                        "strategy_name": "Monetary Momentum Window",
                        "category": "CORRELATION"
                    }

                    signal = TradingSignal(
                        strategy_id="correlation_20",
