"""
EtfCreateRedeemLatencyEdgeStrategy
==================================
...
class EtfCreateRedeemLatencyEdgeStrategy(BaseArbitrageStrategy):
    """
    ETF Create/Redeem Latency Edge
    ...
    async def generate_signals(self) -> List[TradingSignal]:
        """Generate etf_arbitrage arbitrage signals"""
        signals = []
            ...
            for symbol in self.universe:
                ...
                if abs(signal_value) > self.threshold:
                    ...
                    metadata = {
                        ...
                        "strategy_name": "ETF Create/Redeem Latency Edge",
                        "category": "ETF_ARBITRAGE"
                    }

                    signal = TradingSignal(
                        strategy_id="etf_arbitrage_33",
