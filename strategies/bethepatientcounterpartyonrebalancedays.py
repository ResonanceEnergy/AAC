"""
BeThePatientCounterpartyOnRebalanceDaysStrategy
===============================================
...
class BeThePatientCounterpartyOnRebalanceDaysStrategy(BaseArbitrageStrategy):
    """
    Be the Patient Counterparty on Rebalance Days
            ...
            for symbol in self.universe:
                ...
                if abs(signal_value) > self.threshold:
                    ...
                    metadata = {
                        ...
                        "strategy_name": "Be the Patient Counterparty on Rebalance Days",
                        "category": "CORRELATION"
                    }

                    signal = TradingSignal(
                        strategy_id="correlation_17",
