"""
NlpGuidedOvernightSelectorStrategy
==================================
...
class NlpGuidedOvernightSelectorStrategy(BaseArbitrageStrategy):
    """
    NLP-Guided Overnight Selector
            ...
            for symbol in self.universe:
                ...
                if abs(signal_value) > self.threshold:
                    ...
                    metadata = {
                        ...
                        "strategy_name": "NLP-Guided Overnight Selector",
                        "category": "SEASONALITY"
                    }

                    signal = TradingSignal(
                        strategy_id="seasonality_22",
