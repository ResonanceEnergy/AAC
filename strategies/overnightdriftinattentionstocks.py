"""
OvernightDriftInAttentionStocksStrategy
=======================================
...
class OvernightDriftInAttentionStocksStrategy(BaseArbitrageStrategy):
    """
    Overnight Drift in Attention Stocks
            ...
            for symbol in self.universe:
                ...
                if abs(signal_value) > self.threshold:
                    ...
                    metadata = {
                        ...
                        "strategy_name": "Overnight Drift in Attention Stocks",
                        "category": "SEASONALITY"
                    }

                    signal = TradingSignal(
                        strategy_id="seasonality_50",
