"""
OvernightVsIntradayVarianceSkewStrategy
=======================================
...
class OvernightVsIntradayVarianceSkewStrategy(BaseArbitrageStrategy):
    """
    Overnight vs Intraday Variance Skew
            ...
            for symbol in self.universe:
                ...
                if abs(signal_value) > self.threshold:
                    ...
                    metadata = {
                        ...
                        "strategy_name": "Overnight vs Intraday Variance Skew",
                        "category": "VOLATILITY_ARBITRAGE"
                    }

                    signal = TradingSignal(
                        strategy_id="volatility_arbitrage_40",
