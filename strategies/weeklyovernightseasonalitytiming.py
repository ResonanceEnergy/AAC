"""
WeeklyOvernightSeasonalityTimingStrategy
========================================
...
class WeeklyOvernightSeasonalityTimingStrategy(BaseArbitrageStrategy):
    """
    Weekly Overnight Seasonality Timing
    ...
    async def generate_signals(self) -> List[TradingSignal]:
        """Generate seasonality arbitrage signals"""
        signals = []
            ...
            for symbol in self.universe:
                ...
                if abs(signal_value) > self.threshold:
                    ...
                    metadata = {
                        ...
                        "strategy_name": "Weekly Overnight Seasonality Timing",
                        "category": "SEASONALITY"
                    }

                    signal = TradingSignal(
                        strategy_id="seasonality_26",
