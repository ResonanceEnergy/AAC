"""
PreFomcRegimeSwitchFilterStrategy
=================================
...
class PreFomcRegimeSwitchFilterStrategy(BaseArbitrageStrategy):
    """
    Pre-FOMC Regime Switch Filter
            ...
            for symbol in self.universe:
                ...
                if abs(signal_value) > self.threshold:
                    ...
                    metadata = {
                        ...
                        "strategy_name": "Pre-FOMC Regime Switch Filter",
                        "category": "EVENT_DRIVEN"
                    }

                    signal = TradingSignal(
                        strategy_id="event_driven_29",
