...
class IndexCashAndCarryStrategy(BaseArbitrageStrategy):
    """
    Index Cash-and-Carry
            ...
            for symbol in self.universe:
                ...
                if abs(signal_value) > self.threshold:
                    ...
                    metadata = {
                        ...
                        "strategy_name": "Index Cash-and-Carry",
                        "category": "INDEX_ARBITRAGE"
                    }

                    signal = TradingSignal(
                        strategy_id="index_arbitrage_15",
