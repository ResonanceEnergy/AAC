"""
EuronextImbalanceCaptureStrategy
================================
...
class EuronextImbalanceCaptureStrategy(BaseArbitrageStrategy):
    """
    Euronext Imbalance Capture
            ...
            for symbol in self.universe:
                ...
                if abs(signal_value) > self.threshold:
                    ...
                    metadata = {
                        ...
                        "strategy_name": "Euronext Imbalance Capture",
                        "category": "MARKET_MAKING"
                    }

                    signal = TradingSignal(
                        strategy_id="market_making_32",
