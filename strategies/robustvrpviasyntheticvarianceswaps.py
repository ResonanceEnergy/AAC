"""
RobustVrpViaSyntheticVarianceSwapsStrategy
==========================================
...
class RobustVrpViaSyntheticVarianceSwapsStrategy(BaseArbitrageStrategy):
    """
    Robust VRP via Synthetic Variance Swaps
            ...
            for symbol in self.universe:
                ...
                if abs(signal_value) > self.threshold:
                    ...
                    metadata = {
                        ...
                        "strategy_name": "Robust VRP via Synthetic Variance Swaps",
                        "category": "VOLATILITY_ARBITRAGE"
                    }

                    signal = TradingSignal(
                        strategy_id="volatility_arbitrage_39",
