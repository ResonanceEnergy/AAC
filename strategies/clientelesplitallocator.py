"""
ClienteleSplitAllocatorStrategy
===============================
...
class ClienteleSplitAllocatorStrategy(BaseArbitrageStrategy):
    """
    Clientele Split Allocator
            ...
            for symbol in self.universe:
                ...
                if abs(signal_value) > self.threshold:
                    ...
                    metadata = {
                        ...
                        "strategy_name": "Clientele Split Allocator",
                        "category": "CORRELATION"
                    }

                    signal = TradingSignal(
                        strategy_id="correlation_27",
